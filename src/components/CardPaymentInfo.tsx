      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-gray-200">
          ...
          <div className="mb-8">
            ...
            <h3 className="text-xl font-bold text-blue-700 mb-2">Step 1: Buy BNB Using Your Card</h3>
            <p className="mb-2 text-gray-800">Head to one of these trusted platforms to purchase BSC (BNB):</p>
            <ul className="mb-4 list-disc list-inside space-y-1">
              ...
              <li><a href="https://global.transak.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">Transak</a></li>
              <li><a href="https://www.moonpay.com/buy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">MoonPay</a></li>
            </ul>
            <p className="mb-4 text-gray-500 text-sm">Follow the platform's instructions to buy BNB and send it directly to your wallet.</p>
            <p className="mb-8 text-yellow-700 text-sm font-medium">Tip: To cover all costs, including gas fees for buying $DIMON, we recommend purchasing at least $50 worth of BNB.</p>
            <h3 className="text-xl font-bold text-blue-700 mb-2">Step 2: Swap BNB for $DIMON</h3>
            <p className="mb-2 text-gray-800">Once BNB is in your wallet, use it to purchase $DIMON.</p>
            <ul className="mb-4 list-disc list-inside space-y-1">
              <li>Connect your wallet to the Dimon website.</li>
              <li>Follow the steps outlined in the "How to Buy $DIMON" guide.</li>
            </ul>
            <p className="text-gray-500 text-sm mt-4"><span className="font-bold text-yellow-700">Note:</span> Make sure your wallet has enough BNB to cover both the $DIMON purchase and any gas fees.</p>
          </div>
        </div>
      </div>
    </section>
